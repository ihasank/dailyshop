          ...
          <div class="aa-product-catg-content">
            ...
            <div class='aa-product-catg-body'>
                ...
                <!-- start single product item -->
                  ...
                  <?php 
                    include ('db.php');
                    $sql = "SELECT * FROM products where tags='Head Phone,'";
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul class="aa-catg-nav">
                <li><a href="mencat.php">Men</a></li>
                <li><a href="womencat.php">Women</a></li>
                <li><a href="kidscat.php">Kids</a></li>
                <li><a href="ecat.php">Electornics</a></li>
                <li><a href="sportscat.php">Sports</a></li>
              </ul>
            </div>
            <!-- single sidebar -->
            <div class="aa-sidebar-widget">
